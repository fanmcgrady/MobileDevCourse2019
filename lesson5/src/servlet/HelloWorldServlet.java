...
//        UserInfo userInfo = UserDao.getUserInfoById(studentId);
        List<UserInfo> userInfoList = UserDao.listUser();
        
        UserResult result = new UserResult();
        result.setUserInfoList(userInfoList);
        
        userResult = new JSONObject(result);
